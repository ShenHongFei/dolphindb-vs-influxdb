...
.
└── select
    ├── execution_time: 905.370502ms
    ├── planning_time: 3.742844ms
    ├── total_time: 909.113346ms
...
.
└── select
    ├── execution_time: 283.971220ms
    ├── planning_time: 18.209847ms
    ├── total_time: 302.181067ms
...
.
└── select
    ├── execution_time: 51m29.701935295s
    ├── planning_time: 5.358718424s
    ├── total_time: 51m35.060653719s
...
.
└── select
    ├── execution_time: 55m45.256436988s
    ├── planning_time: 4.563051279s
    ├── total_time: 55m49.819488267s
